    ...
    form.addEventListener("submit", function (e) {
      ...
      postData("assets/server.php", formData).then(function (res) {
        ...
        setTimeout(function () {
          ...
          var formParents = form.parentElement.parentElement.parentElement.parentElement;

          if (formParents.classList.contains("popup") || formParents.classList.contains("popup_engineer") || formParents.classList.contains("popup_calc_end")) {
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  function hideTabContent() {
    content.forEach(function (item) {
      ...
      item.classList.remove('myAnimation');
    });
  ...
  function showTabContent() {
    ...
    content[i].classList.add('myAnimation');
